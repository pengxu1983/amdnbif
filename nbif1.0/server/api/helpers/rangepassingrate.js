module.exports = {
  ...
  friendlyName: 'Rangepassingrate',


  description: 'Rangepassingrate something.',
    ...
    while(item  !=  moment(inputs.dateend).format('YYYY-MM-DD')){
      ...
      if(one_reg_official_normal){
        ...
        await Regression_log.update({
          ...
          passingrate : passingrate_official_normal,
      ...
      if(one_reg_official_long){
        ...
        await Regression_log.update({
          ...
          passingrate : passingrate_official_long,
      ...
      if(one_reg_official_pg){
        ...
        await Regression_log.update({
          ...
          passingrate : passingrate_official_pg,
      ...
      if(one_reg_official_baco){
        ...
        await Regression_log.update({
          ...
          passingrate : passingrate_official_baco,
